...
<title>My JSP 'readers.jsp' starting page</title>
...
<script type="text/javascript">
	...
	function search() {
		...
		if (input == "") {
			...
			var s = "<thead><tr><th>readerId</th><th>idCard</th><th>readerName</th><th>readerPhone</th><th>edit</th></tr></thead>"
			table.innerHTML = s;
			fun();
		}
		//alert(input);
		...
		function display(data) {
			...
			for (var i = 0; i < data.length; i++) {
				var s = "<thead><tr><td>" + data[i].readerId + "</td><td>" + data[i].idCard + "</td><td>" +
					data[i].readerName + "</td><td>" + data[i].readerPhone + "</td><td>"+data[i].email+
					"</td><td><a href=\"EditServlet?readerId="+data[i].readerId+"\"><button type=\"button\" class=\"btn btn-primary\">Detail</button></a></td></tr></thead>";
